...
describe('Food day view', () => {
  it('renders meal sections in order and sums the daily total from fixture entries', async () => {
    ...
    expect(screen.getByText('540 kcal')).toBeTruthy();
    expect(screen.getByText('56.5g')).toBeTruthy();
    expect(screen.getByText('43g')).toBeTruthy();
    expect(screen.getByText('11.5g')).toBeTruthy();
  });
});
